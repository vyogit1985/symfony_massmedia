...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony_massmedia', 'user' => 'symfony_user', 'password' => 'symfony_user', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/MassMedia/BlogBundle/Entity'))), 'MassMedia\\BlogBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MassMediaBlogBundle' => 'MassMedia\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_56f0db9dfe574a374242bae88a692e951782b1afd6ae0949d6b40850cfe796a8');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MassMedia/BlogBundle/Resources/views'), 'MassMediaBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('521ee7784d26d35b48a80641d88c1105196433a9');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5960cdbe1f90b1.64061341')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MassMediaBlogBundle' => 'MassMedia\\BlogBundle\\MassMediaBlogBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MassMediaBlogBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/MassMedia/BlogBundle'),
            ...
            'database_port' => NULL,
            'database_name' => 'symfony_massmedia',
            'database_user' => 'symfony_user',
            'database_password' => 'symfony_user',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '521ee7784d26d35b48a80641d88c1105196433a9',
            'locale' => 'en',
            ...
            'kernel.secret' => '521ee7784d26d35b48a80641d88c1105196433a9',
